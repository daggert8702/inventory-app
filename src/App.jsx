...
const GOOGLE_SCRIPT_URL =
  "https://script.google.com/macros/s/AKfycbz6LuiOqUCGCKkUF2WWTcsx70sm4ctxJYNLMqLoVNqMBr4z61iTyN43Tz79rXAZ7fZ7/exec";
...
export default function InventorySalesCalculator() {
  ...
  const canSeeItem = (item) => {
    const employeeRankValue =
      RANK_VALUE[currentRank] || 1;

    const itemRankValue =
      RANK_VALUE[item.minRank] || 1;
  ...
  const endShift = async () => {
    ...
    const ok =
      window.confirm(
        "End shift and submit shift summary?"
      );
